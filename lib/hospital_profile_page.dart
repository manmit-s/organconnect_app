      ...
      body: SingleChildScrollView(
        ...
        child: Column(
          ...
          children: [
            ...
            MyTextField(hintText: 'Hospital Name', obscureText: false, width: screenWidth * 0.9),
            SizedBox(height: screenHeight * 0.015),
            _buildLabel("Affiliation Code", screenWidth),
            MyTextField(hintText: 'Affiliation Code', obscureText: false, width: screenWidth * 0.9),
            SizedBox(height: screenHeight * 0.015),
            _buildLabel('Organ Availability', screenWidth),
            MyTextField(hintText: 'Organs Available', obscureText: false, width: screenWidth * 0.9),
            SizedBox(height: screenHeight * 0.015),
